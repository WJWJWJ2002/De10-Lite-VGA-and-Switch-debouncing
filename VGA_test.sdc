## Generated SDC file "VGA_test.sdc"
...
create_generated_clock -name {vga_pll|altpll_component|auto_generated|pll1|clk[0]} -source [get_pins {vga_pll|altpll_component|auto_generated|pll1|inclk[0]}] -duty_cycle 50/1 -multiply_by 1 -divide_by 2 -master_clock {clk_50} [get_pins {vga_pll|altpll_component|auto_generated|pll1|clk[0]}] 
